...
public class SemaphorPhilosophy {
        ...
        public void run() {
            try {
                while (num < 3)// пока количество приемов пищи не достигнет 3
                {
                    ...
                    sem.acquire();
                    System.out.println("Philosof " + id + " sel za stol");
                    // философ ест
                    sleep(500);
                    num++;

                    System.out.println("Philosof " + id + " pokinul stol");
                    sem.release();
                ...
                System.out.println("U filosofa  " + id + " problemi");
            }
        }
    }
